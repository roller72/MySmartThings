/*
* Philio Slim Multisensor PST02-2C
* Contact, Temperature, Illumination
* Change log:
* 20171110 - C 型沒有 PIR
*/

metadata {
    definition (name: "Philio PST02-2C", namespace: "stratevision", author: "Jack Sun") {
        ...
        fingerprint cc:"5E,72,86,59,73,5A,8F,98,7A", ccOut:"20", sec:"80,71,85,70,30,31,84", role:"06", ff:"8C06", ui:"8C06"
        fingerprint type:0701, mfr:"013C", prod:"0002", model:"000E"
    }
